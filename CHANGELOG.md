...
- **How to Split** — enter the total on a bill, a custom ratio (60/40, not
  just 50/50), and whatever was really just one person's — a PS5, a makeup
  order — and it tells you exactly what each person pays. Individual items
  come off the total before the ratio runs and land back on their owner in
  full, never touched by the split.
